...
import main.java.branchOffice.BranchOffice;
import main.java.branchOffice.DataBaseContent;

import javax.swing.*;
import java.awt.*;
import java.util.ArrayList;

public class HeadOffice extends JFrame {
    ...
    protected HeadMessaging messagingService;
    ...
    public HeadOffice (){
        dba = new DataBaseAccess("Head_Office_db", "root", "");
        messagingService = new HeadMessaging();
        messagingService.receive(dba);
        sales = dba.getAll();
